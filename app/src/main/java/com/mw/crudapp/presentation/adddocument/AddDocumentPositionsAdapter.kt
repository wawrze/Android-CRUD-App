        ...
        fun bindNewPosition(adapter: AddDocumentPositionsAdapter) {
            itemView.apply {
                ...
                item_new_document_position_add.setOnClickListener {
                    ...
                    val amount = item_new_document_position_amount_input.text.toString().toDoubleOrNull() ?: 0.0
                    val netPrice = item_new_document_position_net_price_input.text.toString().toDoubleOrNull() ?: 0.0
                    val grossPrice =
                        item_new_document_position_gross_price_input.text.toString().toDoubleOrNull() ?: 0.0
                    clearInputs()
